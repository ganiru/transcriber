...
def request_code():
    ...
    try:
        url = os.getenv('N8N_SEND_CODE_URL')# "http://localhost:5678/webhook-test/71b2080a-a87c-4ce9-8988-f399014b33a9" # "https://hook.us1.make.com/dd1bfitgetovob1cjf7d2sb53xz8d32q"
